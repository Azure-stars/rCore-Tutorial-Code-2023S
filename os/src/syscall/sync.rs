...
pub fn sys_mutex_create(blocking: bool) -> isize {
    ...
    // 获取锁的编号
    // 为其分配一个新的rid与占用资源
    process_inner.alloc_index_for_resource(mutex_id as usize, "mutex".to_string(), 1);
    // 锁的可用余量仅有1
    mutex_id
}
/// mutex lock syscall
...
pub fn sys_semaphore_create(res_count: usize) -> isize {
    ...
    process_inner.alloc_index_for_resource(id, "sem".to_string(), res_count);
    id as isize
}
